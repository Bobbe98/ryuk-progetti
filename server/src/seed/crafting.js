// SRD items do not include crafting rules (DMG downtime crafting is not
// OGL content), so we generate a plausible, homebrew "materiali e
// procedura" recipe deterministically from category + rarity. The result
// is clearly homebrew flavour text, not a reproduction of any published
// crafting subsystem.
const RARITY_DAYS = {
  common: 5,
  uncommon: 10,
